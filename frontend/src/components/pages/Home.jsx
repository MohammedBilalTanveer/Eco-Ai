...
const FeatureCard = ({ title, description, path, Icon }) => (
  <motion.div
    ...
    className="bg-gray-900 backdrop-blur-md px-10 py-8 w-full sm:w-[500px] h-[340px] rounded-xl border border-white/10 shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] flex flex-col justify-between items-center text-center hover:shadow-[0_0_30px_2px_rgba(130,69,236,0.5)] transition-shadow"
  >
    <div className="flex flex-col items-center flex-grow">
      <Icon className="text-[#8245ec] text-6xl mb-4" />
      <h3 className="text-2xl sm:text-3xl font-semibold text-gray-300 mb-3">{title}</h3>
...
const Home = () => {
  return (
    <div className="bg-[#050414] min-h-screen relative overflow-hidden">
      ...
      <div className="relative pt-32 pb-20 px-[8vw]">
        ...
        <section id="features" className="grid sm:grid-cols-2 gap-10 justify-center items-center max-w-6xl mx-auto">
          <FeatureCard
            title="Report Waste"
