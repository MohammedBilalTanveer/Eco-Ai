...
const ReportPage = () => {
  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition(
      ...
      () => setPosition({ lat: 12.9716, lng: 77.5946 }) // fallback Bengaluru
    );
  }, []);
    ...
    <div className="bg-[#050414] min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-4xl text-center text-white font-bold mb-2">
          Report <span className="text-[#8245ec]">General Waste</span>
        </h1>
        <p className="text-center text-gray-400 mb-8">
          Help keep your city clean. AI will analyze your image for garbage.
        </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                rows="3"
                placeholder="e.g., Overflowing bin on corner street"
                className="w-full pl-10 p-3 bg-gray-800/80 rounded-lg focus:ring-2 focus:ring-[#8245ec] outline-none text-white"
              />
            </div>

            <div className="relative">
              <FiAlertCircle className="absolute left-3 top-3 text-gray-400 text-xl" />
              <select
                value={severity}
